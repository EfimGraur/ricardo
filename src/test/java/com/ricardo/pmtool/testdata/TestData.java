...
public class TestData {
    ...
    public static UserData TEST_USER1 = new UserData(TEST_ID, TEST_EMAIL, TEST_FIRST_NAME, TEST_LAST_NAME, TEST_USERNAME, TEST_ADMIN_ROLE, null);
    public static UserData TEST_USER2 = new UserData(TEST_ID + 1,
            TEST_EMAIL + 2,
            TEST_FIRST_NAME + 2,
            TEST_LAST_NAME + 2,
            TEST_USERNAME + 2,
    ...
    public static ProjectData TEST_PROJECT1 = new ProjectData(TEST_ID, TEST_CODE, TEST_PROJECT_NAME, TEST_ASSIGNEE);
    public static ProjectData TEST_PROJECT2 = new ProjectData(TEST_ID + 1, TEST_CODE + 2, TEST_PROJECT_NAME + 2, TEST_ASSIGNEE + 2);
    ...
    public static TaskData TEST_TASK1 = new TaskData(TEST_ID, TEST_DESCRIPTION, TEST_PM, TEST_PROGRESS, TEST_STATUS, null, TEST_CODE, TEST_ASSIGNEE);
    public static TaskData TEST_TASK2 = new TaskData(TEST_ID+1, TEST_DESCRIPTION+2, TEST_PM, TEST_PROGRESS, TEST_STATUS, null, TEST_CODE+2, TEST_ASSIGNEE+2);
}
